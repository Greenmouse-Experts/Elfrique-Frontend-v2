  ...
  <section class="contestant-profile">
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="img-area">
            ...
            <img :src="contestant?.image?.match(/^http/)?contestant.image:`${this.IMAGES_BASE_URL}${contestant.image}`" />
          </div>
          <div class="text-area">
    ...
    <div class="container service-content-vote mt-5">
      <div class="row tab-content">
        ...
        >
          <div class="card">
            <img :src="con?.image?.match(/^http/)?con.image:`${this.IMAGES_BASE_URL}${con.image}`" class="card-img-top" />
            <div class="card-body">
