  ...
  <section class="voting-content">
    <div class="container header-cont">
      <div class="row">
        <div class="col-md-4">
          <div class="img-area">
            <img :src="this.IMAGES_BASE_URL+ contest.image" ondragstart="return false;" />
          </div>
        </div>
        <div class="col-md-6">
          <div class="text-title-area">
            ...
            <small
              >Organised by :
              <span
                >{{ contest.organiser.first_name }}
                {{ contest.organiser.last_name }}</span>
              <!-- <span
                >{{ contest.organiser.firstname }}
                {{ contest.organiser.lastname }}</span
              > -->
              </small
            >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          >
            ...
            <li class="nav-item" role="presentation" v-show="contest.organiser_profile_display">
              <button
                class="nav-link tabs-button"
                id="pills-organ-tab"
                data-bs-toggle="pill"
              ...
              <div class="container" v-if="ended == false">
                <div class="row">
                  ...
                  >
                    <div class="card">
                      <img
                        :src="con?.image.match(/^http/)?con.image:`${this.IMAGES_BASE_URL}${con.image}`"
              ...
              <div class="container organiser-area">
                <div class="row justify-content-center px-2">
                  <div class="col-lg-10">
                    ...
                    <h4>Name</h4>
                    <p>
                      <!-- {{ contest.organiser.fullname }} -->
                      {{ contest.organiser.first_name }}
                      {{ contest.organiser.last_name }}
                    </p>
                    <h4>Email</h4>
                    <p>{{ contest.organiser.email }}</p>
                    <h4>Phone Number</h4>
                    <p>{{ contest.organiser.phone }}</p>
                    <h4>About</h4>
                    <h6>{{ contest.organiser.about }}</h6>
                  </div>
                </div>
              </div>
            </div>
...
import {IMAGES_BASE_URL } from "../configs";
export default {
  name: "Elfrique",
  ...
  mounted() {
    window.scrollTo(0, 0);
    console.log('base url is',this.IMAGES_BASE_URL)
  },
};
</script>
